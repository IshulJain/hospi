# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2018-02-11 18:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facility', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Auth.Facility')),
            ],
        ),
        migrations.CreateModel(
            name='InstituteDay',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funding', models.CharField(blank=True, max_length=200, null=True)),
                ('teamName', models.CharField(max_length=35)),
                ('bType', models.ManyToManyField(blank=True, null=True, related_name='btype', to='Auth.BusinessType')),
            ],
        ),
        migrations.CreateModel(
