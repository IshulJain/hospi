...
, function(t, e) {
    ...
    t.exports = '<div class="content-wrapper">\n    <div class="content">\n        <h2 class="h1 m4 c6" style="font-size:3rem !important;">\n            {{event_name}}\n        </h2>\n        <img src="hideme" class="if-mobile">\n        <div class="col-container clearfix">\n            <div class="col left m1 c3 content-link content-link--desktop">\n                <div class="img-container r--16-9">\n                    <img src="hideme" />\n                </div>\n           <a href="" title="prizeMoney"  class="btn btn--rect btn--rect--picto" style="margin-bottom:5%; visibility:visible !important;">\n                    <span class="i-more-wrap"></span>\n                    <span class="btn__content">\n                        <span class="btn__content-label"><b>Prizes Worth {{prizeMoney}} </b></span>\n                        <span class="btn__content-layer" data-content="<b>Prizes Worth {{prizeMoney}} </b>"></span>\n                    </span> \n                </a>\n       <a href="{{register_link}}" title="{{event_register}}" target="_blank" class="btn btn--rect btn--rect--picto" style="visibility:visible !important;">\n                    <span class="i-more-wrap"></span>\n                    <span class="btn__content">\n                        <span class="btn__content-label">{{event_register}}</span>\n                        <span class="btn__content-layer" data-content="{{event_register}}"></span>\n                    </span> \n                </a>\n            </div>\n            <div class="col right c6 clearfix p">\n                {{event_content}}\n            </div>\n            <div class="col left m1 c3 r--16-9 content-link content-link--mobile if-mobile">\n                <a href="{{register_link}}" title="{{event_register}}" target="_blank" class="btn btn--rect btn--rect--picto" style="visibility:visible !important;">\n                    <span class="i-more-wrap"></span>\n                    <span class="btn__content">\n                        <span class="btn__content-label">{{event_register}}</span>\n                        <span class="btn__content-layer" data-content="{{event_register}}"></span>\n                    </span> \n                </a>\n            </div>\n                     <div class="locations js-locations clearfix m4 c6">\n            </div>\n        </div>\n      </div>\n</div>\n'
}
, function(t, e) {
    ...
    t.exports = ' <div class="address-container c8">\n    <div class="address">\n        <h3 class="h2 m1 c9" style="font-size:2.2rem;">\n            {{optionName}}\n        </h3>\n       <div class="details p" style="padding-top: 3% !important; padding-bottom: 5% !important;">\n            {{optionDescription}}\n        </div>\n            </div>\n</div>'
}
, function(t, e, i) {
    var n, o;
    !function(s, r) {
